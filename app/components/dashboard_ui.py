...
def file_upload_section(
    ...
    remove_handler: rx.event.EventType,
) -> rx.Component:
                ...
                rx.foreach(
                    ...
                    lambda file: rx.el.div(
                        ...
                        rx.el.a(
                            ...
                            target="_blank",
                            class_name="hover:underline text-blue-600 flex-1 truncate",
                        ),
                        rx.el.button(
                            rx.icon("x", class_name="h-3 w-3"),
                            on_click=lambda: remove_handler(file),
                            class_name="ml-2 p-1 text-gray-400 hover:text-red-500 hover:bg-red-50 rounded transition-colors",
                            title="Remove file",
                        ),
            ...
            rx.el.div(
                ...
                rx.el.div(
                    file_upload_section(
                        ...
                        DashboardState.remove_research_file,
                    ),
                    class_name="mt-2",
                ),
            ...
            rx.el.div(
                ...
                rx.el.div(
                    file_upload_section(
                        ...
                        DashboardState.remove_employability_file,
                    ),
                    class_name="mt-2",
                ),
                class_name="grid grid-cols-1 lg:grid-cols-2 gap-8",
            ...
            rx.el.div(
                ...
                rx.el.div(
                    file_upload_section(
                        ...
                        DashboardState.remove_global_engagement_file,
                    ),
                    class_name="mt-2",
                ),
                class_name="grid grid-cols-1 lg:grid-cols-2 gap-8",
            ...
            rx.el.div(
                ...
                rx.el.div(
                    file_upload_section(
                        ...
                        DashboardState.remove_learning_experience_file,
                    ),
                    class_name="mt-2",
                ),
                class_name="grid grid-cols-1 lg:grid-cols-2 gap-8",
            ...
            rx.el.div(
                ...
                rx.el.div(
                    file_upload_section(
                        ...
                        DashboardState.remove_sustainability_file,
                    ),
                    class_name="mt-2",
                ),
                class_name="grid grid-cols-1 lg:grid-cols-2 gap-8",
